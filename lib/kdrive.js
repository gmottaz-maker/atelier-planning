...
// Cherche ou crée "Factures fournisseurs / <année>" sous amazing files.
export async function ensureSupplierInvoiceFolder(year) {
  const root  = await findOrCreateChild(AMAZING_FILES_ID, 'Factures fournisseurs')
