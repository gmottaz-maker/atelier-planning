...
export function statutProjet(project) {
  ...
  if (pm) {
    ...
    // « En cours » prend le jaune : c'est la couleur du travail en atelier,
    // et elle le distingue de « terminé », qui garde le vert.
    return { fg: AL.black, bg: C.neutralBg, stripe: C.warning, text }   // en cours
  }
